...
<head>
<meta charset="UTF-8">
<title>다음 주소 API 사용 예제</title>
</head>
<body>
<p>이 예제는 다음 링크 참조하여 작성함</p>
<p><a href="https://postcode.map.daum.net/guide" target="blank">카카오(다음 API)우편번호 서비스</a></p>
<hr>
<form action="${pageContext.request.contextPath}/addr" method="post">
<input type="text" id="memberName" name="memberName" placeholder="회원이름" required="required"><br>
